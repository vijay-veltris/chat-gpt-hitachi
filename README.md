...
3. You can see the local running app at http://0.0.0.03000.
...
4. You can see the local running app at http://0.0.0.03000.
...
As above, start the app with `start.cmd`, then visit the local running app at http://0.0.0.03000. Or, just run the backend in debug mode using the VSCode debug configuration in `.vscode/launch.json`.
